...
- [x] Nest flock unlocks: Common always free; Pied / Oriental Dwarf / Belted / Azure / Yellow-billed / Banded / Green via vs-bots missions; Create game gates human bird pick; vs-bots Create game also assigns bot birds (`speciesBySeat`); `G.speciesBySeat` decouples seat from species
