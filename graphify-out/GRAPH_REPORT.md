...
## Corpus Check
- 118 files · ~372,708 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 744 nodes · 1936 edges · 38 communities (33 shown, 5 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f99895ac`
...
### Community 1 - "App.tsx"
Cohesion: 0.07
Nodes (48): App(), BotsMode, Mode, OnlineGame(), OnlineMode, filledCount(), GameLobby(), MatchListItem (+40 more)
...
Cohesion: 0.15
Nodes (20): RiverBoardProps, EddySwirlSvg(), EddySwirlSvgProps, ZoneKindBadge(), BADGE_CLASS, DRIFT_CLASS, KIND_CLASS, ZoneTile() (+12 more)

### Community 5 - "StatusLine.tsx"
Cohesion: 0.06
Nodes (88): CreateBotRoster(), CreateBotRosterProps, CreateGame(), CreateOnline(), SeatKind, GameOver(), maybeRecord(), GatherPanel() (+80 more)
...
Cohesion: 0.10
Nodes (40): absorbReveals(), driftMemory(), knownFishIn(), pruneCaught(), syncMemory(), bestPlayer(), drawOne(), driftFaceUp() (+32 more)
...
Cohesion: 0.14
Nodes (15): PRIORITY, Row, ROWS, RulesCheatsheet(), RulesCheatsheetProps, SpecialKind, ZoneKindBadgeProps, ZoneKind (+7 more)

### Community 31 - "zones.ts"
Cohesion: 0.19
Nodes (9): FishCard(), FishCardBack(), FishIcon(), FishIconProps, RevealLine(), FishCard, DriftPlan, FISH_LABEL (+1 more)

### Community 32 - "RiverBoard.tsx"
Cohesion: 0.24
Nodes (8): RiverBoard(), BankFoliageSvg(), BankFoliageSvgProps, MossTuftSvg(), MossTuftSvgProps, RiverChannelSvg(), reachableZones(), driftVisualFor()

### Community 33 - "Perch.tsx"
Cohesion: 0.16
Nodes (13): Perch(), PerchProps, REACTION_CLASS, PerchOccupant, RosterSheetProps, BranchSvg(), BranchSvgProps, ReedSvg() (+5 more)
...
Cohesion: 0.33
Nodes (8): calloutFor(), phaseText(), StatusActor, StatusHandControl, StatusLine(), StatusLineProps, specialKindsIn(), outcomeStory()
...
## Knowledge Gaps
- **187 isolated node(s):** `Stats`, `BotKind`, `Stats`, `state`, `order` (+182 more)
...
- **Why does `GameState` connect `stepFeedback.ts` to `Perch.tsx`, `StatusLine.tsx`, `game/types.ts`, `App.tsx`, `StatusLine.tsx`, `ZoneTile.tsx`, `types.ts`, `resolution.ts`, `legacy.ts`, `lesson.ts`, `zones.ts`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `KingfisherID` connect `StatusLine.tsx` to `RiverBoard.tsx`, `App.tsx`, `Perch.tsx`, `ZoneTile.tsx`, `types.ts`, `stepFeedback.ts`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `CardType` connect `CardType` to `Perch.tsx`, `App.tsx`, `ZoneTile.tsx`, `StatusLine.tsx`, `types.ts`, `resolution.ts`, `legacy.ts`, `lesson.ts`, `RosterSheet.tsx`, `zones.ts`?**
