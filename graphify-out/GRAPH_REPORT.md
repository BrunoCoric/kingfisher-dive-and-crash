...
## Corpus Check
- 89 files · ~76,298 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 583 nodes · 1471 edges · 20 communities (19 shown, 1 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5902dd96`
...
### Community 1 - "App.tsx"
Cohesion: 0.10
Nodes (30): App(), BotsGame(), BotsMode, Mode, TutorialGame(), GameLobby(), FLOCK, TitleDiorama() (+22 more)
...
Cohesion: 0.08
Nodes (55): CreateGame(), GameOver(), maybeRecord(), FLOCK, NestPanel(), RosterButton(), RosterButtonProps, Kingfisher (+47 more)
...
Cohesion: 0.10
Nodes (38): Board(), BoardExtra, PendingSelection, ActionCard(), ActionCardProps, ActionIcon(), ActionIconProps, Hand() (+30 more)

### Community 8 - "resolution.ts"
Cohesion: 0.08
Nodes (50): assert(), fresh(), main(), bestPlayer(), drawOne(), driftFish(), driftPeeked(), endOfRoundCleanup() (+42 more)
...
Cohesion: 0.05
Nodes (53): avg(), BotKind, main(), makeBot(), newStats(), report(), simulate(), Stats (+45 more)

### Community 20 - "lesson.ts"
Cohesion: 0.15
Nodes (21): Props, TutorialCoach(), actionLesson(), cleanupReviewKey(), lessonFor(), outcomeKinds(), reviewLesson(), stepReviewKey() (+13 more)
...
## Knowledge Gaps
- **145 isolated node(s):** `Stats`, `BotKind`, `Stats`, `state`, `order` (+140 more)
...
- **Why does `GameState` connect `stepFeedback.ts` to `App.tsx`, `StatusLine.tsx`, `types.ts`, `resolution.ts`, `RiverBoard.tsx`, `legacy.ts`, `lesson.ts`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `CardType` connect `types.ts` to `App.tsx`, `StatusLine.tsx`, `resolution.ts`, `RiverBoard.tsx`, `legacy.ts`, `lesson.ts`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `KingfisherID` connect `StatusLine.tsx` to `RiverBoard.tsx`, `App.tsx`, `stepFeedback.ts`, `resolution.ts`?**
